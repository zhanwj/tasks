...
DATASETS = {
    ...
    'cityscapes_fine_instanceonly_seg_val': {
        IM_DIR:
            _DATA_DIR + '/lib/datasets/data/cityscapes/images',
    ...
    'cityscapes_semseg_train': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/train.txt'
    },
    'cityscapes_semseg_val': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/val.txt'
    },
    'cityscape_train_on_val': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/Cityscape_disp_SegFlow_train.txt'
    },
    'cityscape_val_on_val': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/Cityscape_disp_SegFlow_val.txt'
    },
    'cityscapes_semseg_test': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/test.txt'
    },
    'cityscapes_all': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/coarse_fine_mixed.txt'
    },
    'cityscapes_coarse': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
    ...
    'cityscapes_fineturn': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
        ANN_FN:
            _DATA_DIR + '/cityscapes/annotations/cityscapes_fineturn.txt'
    },
    'cityscapes_trainval': {
        IM_DIR:
            _DATA_DIR + '/cityscapes/',
