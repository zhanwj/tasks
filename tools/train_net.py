...
from modeling.model_builder_semseg import Generalized_SEMSEG_BN
from roi_data.loader import RoiDataLoader, MinibatchSampler, collate_minibatch, collate_minibatch_semseg, collate_minibatch_semseg_all
from utils.detectron_weight_helper import load_detectron_weight
from utils.logging import log_stats
from utils.timer import Timer
from utils.training_stats import TrainingStats
from lib.nn_segm import UserScatteredDataParallel, user_scattered_collate, patch_replication_callback
        ...
        if isinstance(m, nn.Linear):
            ...
            if m.bias is not None:
                if cfg.SEM.KEEY_BN:
                    ...
                    group_no_decay.append(m.bias)
    print ('keey %d of bn layers' % keep_bn)
